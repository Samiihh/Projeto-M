<?php
require_once "../controller/grupoDcontroller.php";
require_once "../controller/catController.php";
$controlergrupo = new GrupoDController;
$catcontroller = new CatController;
$lerUmgrupo = $controlergrupo->getgrupo();
$listacategoria = $catcontroller->getGCategoria();

if (isset($_GET['alterarGrupo'])){
    $idg=$_GET['alterarGrupo'];
    $respostag = $controlergrupo->lerUmGrupo($idg);
}
...
<html lang="en">
    ...
    <body>
        ...
        <form enctype="multipart/form-data" name="form2" method="post" action="../controller/grupoController.php">
         ...
         <br>
        <caption>Lista de grupo</caption>
        <br>
        <table border="2">
            <br>
                <tr>
